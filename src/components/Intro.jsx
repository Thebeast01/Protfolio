...
function Intro() {
	return (
		<div className='flex items-center justify-center flex-col text-center pt-20 pb-6 '>
			...
			<h1 className=' text-4xl md:text-7xl mb-1 md:mb-3 font-bold font-[Dekko] text-[#b25050]'>Mohammad Saif</h1>
			<p className='text-base md:text-xl mb-3 font-medium dark:text-amber-200'>Software Engineer & Web Developer</p>
			<p className='text-lg max-w-xl mb-6 font-normal font-[Dekko] dark:text-white'>
				{' '}
